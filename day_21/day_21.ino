...
void loop(void) {
  ...
  drawCenteredString(0, "Hello World!");

  // Display our "Hello World!" message on line 2 (moving down "font_height" bits)
  drawCenteredString(font_height, "Hello Wesley!");
  drawCenteredString(font_height*2, "Hello Charlie!");
  drawCenteredString(font_height*3, "Hello Barret!");
  drawCenteredString(font_height*4, "Hello Rebecca!");
  ...
  if (blink_on) {
    ...
    */
    byte centered_y = (font_height * 5) + ((lander_display.getDisplayHeight() - (font_height * 5)) / 2);
  ...
  // This would be read as "blink on is assigned to not blink on".
