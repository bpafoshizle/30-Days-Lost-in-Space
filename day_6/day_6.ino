 ...
 * - Serial.println(): Display text in the Serial Monitor followed by a newline.
...
void loop() {
   ...
   *
   * We introduce it's use here to map our light_value (which goes from darkest_light to
