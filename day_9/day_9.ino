...
void loop() {
  ...
  if (percentage >= 50.0) {     // battery level is OK, display green
    ...
    displayColor(255, 25, 0);  // display yellow-ish/amber for early warning
  ...
  Serial.println(String(percentage, 2) + "%");  // Display our floating point percentage (like 12.34) WITHOUT a newline
